...
def train(gpu, ngpus_per_node, args):
    ...
    inference_entries = read_splits_mapping()
    ...
    rank = dist.get_rank()
    print("current data sampler rank is %d, replicas is %d, split length: %d, total length: %d, sampledataset entry: %s" % (rank, sampler.__len__(), train_dataset.__len__(), world_size, train_dataset.entries[10]))
