...
if __name__ == '__main__':
    ...
    parser.add_argument('--prediction_root', type=str, required=True, help="Groundtruth directory")
    parser.add_argument('--gt_txt', type=str, help="Groundtruth directory")
    parser.add_argument('--result_txt', type=str, help="Result directory")
    ...
    for seq in seqids:
        ...
        for pred_fold in pred_folds:
            ...
            print("================={}==========================".format(pred_fold.split('/')[-2]))
