...
def train(gpu, ngpus_per_node, args):
    ...
    eval_dataset = KITTI_eigen(root=args.dataset_root, inheight=args.evalheight, inwidth=args.evalwidth, entries=entries, depth_root=args.depth_root, depthvls_root=args.depthvlsgt_root,
